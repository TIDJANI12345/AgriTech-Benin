...
ALLOWED_HOSTS = ['*']  # Render ajoutera automatiquement son domaine
...
# CSRF Trusted Origins (ajoutez votre domaine Render)
CSRF_TRUSTED_ORIGINS = [
    'https://*.render.com',
    'https://cody-dicastic-apocalyptically.ngrok-free.dev',
]
